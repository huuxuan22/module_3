...
public class EmployeeAdd {
    ...
    public EmployeeAdd(int id, String employeeName, String birthday, String iDCard, double salary, String numberPhone, String email, String address, int idEducation, int idPosition, int idDivition, String userName) {
        this.id = id;
